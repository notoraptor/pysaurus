...
class PygameTextRendering:
    ...
    def __init__(self, fonts, size=0, height_delta=2):
    ...
    def render_char(self, c: str) -> pygame.Surface:
        surface, box = self._fonts.get_font(c).render(c, size=self._size)
        return surface
    ...
    def parse_char(self, c: str):
        ...
        return CharTask(c, font, width, horizontal_shift)
