System.register(["./Callbacks.js"], function (_export, _context) {
  "use strict";

  var Callbacks, NotificationManager, GENERIC_CALLBACK_NAME;
  _export("NotificationManager", void 0);
  return {
    setters: [function (_CallbacksJs) {
      Callbacks = _CallbacksJs.Callbacks;
    }],
    execute: function () {
      GENERIC_CALLBACK_NAME = "notify";
      _export("NotificationManager", NotificationManager = class NotificationManager {
        constructor() {
