...
export const FIELD_MAP = new FieldMap([
    ...
    new FieldInfo('file_title_numeric', 'file title (with numbers)', GroupPermission.ONLY_MANY, true),
    ...
    new FieldInfo('title_numeric', 'title (with numbers)', GroupPermission.ONLY_MANY, true),
