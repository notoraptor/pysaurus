...
from pysaurus.core.video_raptor.functions import (__PtrPtrVideoInfo, __PtrPtrVideoThumbnail, __PtrVideoInfo,
                                                  __PtrVideoThumbnail, __fn_ErrorReader_init, __fn_ErrorReader_next,
                                                  __fn_VideoInfo_clear, __fn_VideoInfo_init, __fn_VideoRaptorInfo_clear,
                                                  __fn_VideoRaptorInfo_init, __fn_VideoReport_hasError,
                                                  __fn_VideoReport_isDone, __fn_VideoThumbnail_init,
                                                  __fn_videoRaptorDetails, __fn_videoRaptorThumbnails)
