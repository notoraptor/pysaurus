...
def main():
    ...
    for platform in platforms:
        ...
        print("Extensions:", platform.extensions)
        ...
        for device in platform.get_devices(cl.device_type.GPU):
            ...
            print("Device address bits", device.address_bits)
            print("Device extensions", device.extensions)
            print("Device global mem size", FileSize(device.global_mem_size))
            print("Device work group size", device.max_work_group_size)
