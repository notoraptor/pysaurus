System.register(["../language.js"], function (_export, _context) {
  ...
  var tr, FieldInfo, FieldMap, GroupPermission, FieldType, FIELD_MAP, PAGE_SIZES, VIDEO_DEFAULT_PAGE_SIZE, VIDEO_DEFAULT_PAGE_NUMBER, SOURCE_TREE, Characters, SearchTypeTitle;
  return {
      ...
      FieldMap = class FieldMap {
        ...
        constructor(fieldInfoList) {
          ...
          for (let fieldInfo of fieldInfoList) {
            if (this.fields.hasOwnProperty(fieldInfo.name)) throw new Error(tr("Duplicated field: {name}", {
              name: fieldInfo.name
            }));
